...
const app = express() // it returns the express app and stores it within the "app" variable.
const port = process.env.PORT || 3000 // port number

app.get("/", (req, res) => { // handles the get resquest at the home route and sends a message.
  res.send("I've created a Server and it's actively listening right now!")
})
